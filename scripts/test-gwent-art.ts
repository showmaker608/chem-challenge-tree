...
assert.equal(distinct.size, 13, 'Ten materials plus three distinct role portraits');
console.log('PASS: thirteen distinct portraits; all lessons and constructed roles mapped; original assets preserved.');
